...
Planned extra vendors (DeepSeek, xAI, Qwen, Mistral, OpenRouter, MCP, and later Cohere / Groq / Together) belong in their own issues. This file is only the profile recipe.
