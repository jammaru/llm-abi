...
- `docs` — user guide, API, CLI, profiles, requests, local runtimes, guarantees, and architecture. The playground build publishes those pages at `/docs/`
